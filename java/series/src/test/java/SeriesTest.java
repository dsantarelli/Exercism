...
public class SeriesTest {
  ...
  public void canSliceByOne() {
    Series series = new Series("01234");
    List<List<Integer>> expected = Arrays.asList(Collections.singletonList(0), Collections.singletonList(1),
        Collections.singletonList(2), Collections.singletonList(3), Collections.singletonList(4));
  ...
  public void canSliceByTwo() {
    ...
    List<List<Integer>> expected = Arrays.asList(Arrays.asList(9, 8), Arrays.asList(8, 2), Arrays.asList(2, 7),
        Arrays.asList(7, 3), Arrays.asList(3, 4), Arrays.asList(4, 6), Arrays.asList(6, 3));
  ...
  public void canSliceByThree() {
    Series series = new Series("01234");
    List<List<Integer>> expected = Arrays.asList(Arrays.asList(0, 1, 2), Arrays.asList(1, 2, 3),
        Arrays.asList(2, 3, 4));
  ...
  public void canSliceByThreeWithDuplicateDigits() {
    ...
    List<List<Integer>> expected = Arrays.asList(Arrays.asList(3, 1, 0), Arrays.asList(1, 0, 0), Arrays.asList(0, 0, 1));
    List<List<Integer>> actual = series.slices(3);
    assertNotNull(actual);
    assertFalse(actual.isEmpty());
    assertEquals(expected, actual);
  ...
  public void canSliceByFour() {
    ...
    List<List<Integer>> expected = Arrays.asList(Arrays.asList(9, 1, 2, 7), Arrays.asList(1, 2, 7, 4));
  ...
  public void canSliceByFive() {
    ...
    List<List<Integer>> expected = Arrays.asList(Arrays.asList(8, 1, 2, 2, 8));
