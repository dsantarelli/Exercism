...
public class LargestSeriesProductCalculatorTest {
  ...
  public void testSeriesLengthLongerThanLengthOfStringToTestIsRejected() {
    ...
    expectedException.expectMessage("Series length must be less than or equal to the length of the string to search.");
  ...
  @Test
  public void testStringToSearchContainingNonDigitCharacterIsRejected2() {
    expectedException.expect(IllegalArgumentException.class);
    expectedException.expectMessage("String to search may only contains digits.");
    new LargestSeriesProductCalculator("1   1");
  }
  
  @Test
  public void testStringToSearchContainingNonDigitCharacterIsRejected3() {
    expectedException.expect(IllegalArgumentException.class);
    expectedException.expectMessage("String to search may only contains digits.");
