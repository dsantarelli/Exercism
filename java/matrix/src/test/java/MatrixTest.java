...
public class MatrixTest {
  ...
  public static class CountRowsTest {
    ...
    public static Collection<Object[]> data() {
      return Arrays.asList(new Object[][] { { "0", 1 }, { "0 1", 1 }, { "0\n" + "1", 2 }, { "0 1\n" + "2 3", 2 },
          { "0 1 2\n" + "3 4 5\n" + "6 7 8", 3 } });
    }
  ...
  public static class CountColumnsTest {
    ...
    public static Collection<Object[]> data() {
      return Arrays.asList(new Object[][] { { "0", 1 }, { "0 1", 2 }, { "0\n" + "1", 1 }, { "0 1\n" + "2 3", 2 },
          { "0 1 2\n" + "3 4 5\n" + "6 7 8", 3 } });
    }
  ...
  public static class GetFirstRowTest {
    ...
    public static Collection<Object[]> data() {
      return Arrays.asList(
          new Object[][] { { "0", new int[] { 0 } }, { "0 1", new int[] { 0, 1 } }, { "0\n" + "1", new int[] { 0 } },
  ...
  public static class GetFirstColumnTest {
    ...
    public static Collection<Object[]> data() {
      return Arrays.asList(
          new Object[][] { { "0", new int[] { 0 } }, { "0 1", new int[] { 0 } }, { "0\n" + "1", new int[] { 0, 1 } },
              { "0 1\n" + "2 3", new int[] { 0, 2 } }, { "0 1 2\n" + "3 4 5\n" + "6 7 8", new int[] { 0, 3, 6 } } });
    }
  ...
  public static class GetLastColumnTest {
    ...
    public static Collection<Object[]> data() {
      return Arrays.asList(
          new Object[][] { { "0", new int[] { 0 } }, { "0 1", new int[] { 1 } }, { "0\n" + "1", new int[] { 0, 1 } },
              { "0 1\n" + "2 3", new int[] { 1, 3 } }, { "0 1 2\n" + "3 4 5\n" + "6 7 8", new int[] { 2, 5, 8 } } });
    }
